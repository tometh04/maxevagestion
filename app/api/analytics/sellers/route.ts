...
export async function GET(request: Request) {
  try {
    ...
    // Select sale_currency and departure_date for currency conversion
      let query = supabase
        .from("operations")
      .select("id, sale_amount_total, sale_currency, margin_amount, currency, seller_id, departure_date, created_at")
    ...
    // su venta a sale_amount_total para que la venta bruta por vendedor refleje
