...
### 1.1 Actualizar AI Copilot - Contexto Completo

**Objetivo:** El AI debe tener acceso a TODAS las tablas y entender el sistema completo.

**Tareas:**
- [ ] Actualizar `DATABASE_SCHEMA` en `/app/api/ai/route.ts`:
...
- [ ] Actualizar contexto de datos en tiempo real del AI:
