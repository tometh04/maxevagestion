...
See `docs/roadmap/ROADMAP.md` for complete list. Key items:
...
- `docs/setup/CONFIGURACION_SUPABASE.md` - Supabase setup guide
- `docs/testing/GUIA_TESTING.md` - End-to-end testing guide
- `docs/testing/testing-railway-migration.md` - QA checklist post-migración Vercel → Railway
- `docs/roadmap/ROADMAP.md` - Development roadmap and pending tasks
