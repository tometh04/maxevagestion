...
- **Este doc** — `docs/runbooks/HANDOVER.md`
...
- `docs/testing/testing-railway-migration.md` — checklist QA post-Railway, env vars matrix
- `docs/setup/CONFIGURACION_SUPABASE.md` — setup Supabase desde cero

### Roadmap y estado
- `docs/roadmap/ROADMAP.md` — tareas pendientes globales
- `docs/roadmap/ROADMAP-SAAS.md` — roadmap específico de la conversión SaaS

### Testing
- `docs/testing/GUIA_TESTING.md` — testing manual end-to-end
