...
export const operationNewTour: TourDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      tone: "warning",
      title: "“Agregar Operador” no es “agregar tramo”",
      body: "La ficha del operador ya está en pantalla: ahí cargás el costo, el file y la fecha de pago. Sumá otra ficha solo si esta venta se la comprás a más de un mayorista: el aéreo a uno y el hotel a otro, por ejemplo. Cada ficha es un costo, no un tramo del viaje.",
      details: [
        "Si el viaje tiene ida y vuelta pero se lo comprás a un solo operador, dejá una sola ficha. El itinerario se carga después, en el detalle.",
        "Para una operación sin operador, elegí “Sin operador” en el select: la ficha no se borra.",
        "Recién con dos o más fichas aparece el Tipo de Producto por ficha, para separar qué le compraste a cada uno.",
      ],
      placement: "bottom",
      align: "start",
      interactive: true,
