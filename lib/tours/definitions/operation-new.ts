...
export const operationNewTour: TourDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "Cliente",
      body: "Es una sola persona: la que contrata y paga. No es la lista de pasajeros.",
      details: [
        ...
        "Los pasajeros que viajan se cargan después, en el detalle de la operación.",
    ...
    },
    {
      ...
      body: "Acá van las cantidades: dos adultos, un niño. Los nombres, documentos y pasaportes se cargan después, en el detalle de la operación.",
      details: [
        "Es la pregunta más frecuente de quien carga por primera vez: no hay dónde poner los nombres en esta pantalla, y está bien que así sea.",
