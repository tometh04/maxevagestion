...
//
// El alta ya deja cargar al titular y sus acompañantes (VIB-106), pero ahí
// termina: sumar a alguien más tarde, cambiar quién es el titular o completar
// documentos se hace acá.
//
  ...
  steps: [
    {
      ...
      body: "Acá está la gente que viaja. Si en el alta cargaste al titular y sus acompañantes, ya los vas a ver; esto es para sumar a alguien más o corregir.",
      details: [
        ...
        "La lista nunca arranca vacía: el titular que elegiste al crear la operación ya está.",
      ],
    },
    {
      id: "contador",
