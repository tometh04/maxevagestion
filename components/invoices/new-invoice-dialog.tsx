...
import { Loader2, CheckCircle2, AlertCircle, FileText, User, DollarSign, Calendar, StickyNote } from "lucide-react"
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-5 max-h-[75vh] overflow-y-auto">
            ...
            <div className="rounded-xl border border-border/40 bg-muted/20 p-4 space-y-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-[11px] font-semibold uppercase tracking-widest text-foreground/60">Comprobante</h4>
              </div>
            ...
            <div className="rounded-xl border border-border/40 bg-muted/20 p-4 space-y-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-[11px] font-semibold uppercase tracking-widest text-foreground/60">Datos del Receptor</h4>
              </div>
              <div className="grid gap-x-5 gap-y-4 md:grid-cols-2">
                <div className="space-y-2">
            ...
            <div className="rounded-xl border border-border/40 bg-muted/20 p-4 space-y-4">
              ...
              {/* Resumen */}
              <div className="flex gap-4 p-3 bg-background rounded-lg border border-border/30 text-sm">
            ...
            {(concepto === "2" || concepto === "3") && (
              <div className="rounded-xl border border-border/40 bg-muted/20 p-4 space-y-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h4 className="text-[11px] font-semibold uppercase tracking-widest text-foreground/60">Fechas de Servicio</h4>
                </div>
                <div className="grid gap-x-5 gap-y-4 md:grid-cols-2">
                  <div className="space-y-2">
            ...
            <div className="rounded-xl border border-border/40 bg-muted/20 p-4 space-y-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-[11px] font-semibold uppercase tracking-widest text-foreground/60">Notas</h4>
              </div>
              <div className="space-y-2">
