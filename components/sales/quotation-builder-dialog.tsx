...
const ITEM_TYPES = [
  ...
  { value: "INSURANCE", label: "Asistencia", icon: Shield },
  { value: "ACTIVITY", label: "Excursion", icon: MapPin },
...
export function QuotationBuilderDialog({ open, onOpenChange, lead, onSuccess }: QuotationBuilderProps) {
  ...
  async function handleSave(andSend: boolean = false) {
    ...
    try {
      ...
      // If "send", mark as SENT and open WhatsApp
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Nueva Cotizacion — {lead.contact_name}
          </DialogTitle>
        </DialogHeader>
          ...
          {options.map((option, optIndex) => (
            <Card key={option.id} className="border-warning/30">
              ...
              <CardContent className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        <div className="space-y-1">
                          ...
                          <Input
                            ...
                            onChange={(e) => updateItem(option.id, item.id, "hotel_name", e.target.value)}
                ...
                {/* Option total */}
                <div className="flex items-center justify-between">
                  <Label className="text-sm font-medium">Precio total para el cliente</Label>
                  <div className="flex items-center gap-2">
