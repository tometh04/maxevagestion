...
/**
 * Tab de importación masiva. Se usa desde:
 *   - settings-page-client.tsx (como tab dentro de /settings)
 *   - app/(dashboard)/settings/import/page.tsx (URL standalone, link del banner)
 */
export function BulkImportTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold tracking-tight">Importación masiva de datos</h2>
